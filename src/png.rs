...
impl Png {
    ...
    pub fn append_chunks(&mut self, chunk: Chunk) {
        todo!()
    }
    pub fn remove_chunks(&mut self, chunk_type: &str) -> Result<Chunk> {
        todo!()
    }
    ...
    pub fn chunks_by_type(&self, chunk_type: &str) -> Option<&Chunk> {
        todo!()
    }
